...
//  ofstream outfile;
//  outfile.open("myoutput.txt",ios::out);

//  ofstream myoutfile;
 // myoutfile.open("myoutput.txt",ios::out);
...
//initializing histograms
  ...
  TString histoname = (TString)TypeName + "_" + (TString)RootName +  "_results.root";
...
//  delete puw_central;
//  delete FMReco;
  // delete SFP_muon_recoid;
//  delete FEReco;
  // delete SFP_elec_recoid;
//  delete FEMva;
  // delete SFP_elec_mva;
//  delete FEMva3l;
  // delete SFP_elec_mva_3l;
//  delete FMIso;
  // delete SFP_muon_isoip;
//  delete FMIso3l;
  // delete SFP_muon_isoip_3l;
//  delete FEIso;
  // delete SFP_elec_isoip;
//  delete FEIso3l;
  // delete SFP_elec_isoip_3l;
